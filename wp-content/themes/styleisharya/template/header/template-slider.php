<?php
 ...
 for($k=1;$k<=3;$k++){?>
  ...
  while( $slidequery->have_posts() ) : $slidequery->the_post();
   ...
   $image = esc_url(get_the_post_thumbnail_url( $post->ID, 'styleisharya-home-banner-size'));
...
<div class="col-sm-12">
  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <a class="left carousel-control" href="#myCarousel" data-slide="prev">
      ...
      <span class="sr-only"><?php echo esc_html__('Previous','styleisharya')?></span>
    </a>
    <a class="right carousel-control" href="#myCarousel" data-slide="next">
      <span class="glyphicon glyphicon-chevron-right"></span>
      <span class="sr-only"><?php echo esc_html__('Next','styleisharya')?></span>
    </a>
    <?php }?>
  </div><!--myCarousel-->
  <?php }else{?>
